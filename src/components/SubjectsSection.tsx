...
export default function SubjectsSection() {
  ...
  return (
    <section className="mt-24">
      <h2 className="text-4xl font-bold mb-6 text-deepblue text-center">Choose Your Level</h2>
      ...
      <h3 className="text-2xl font-semibold mb-6 text-deepblue text-center">{levels.find(l => l.key === selectedLevel)?.label} Subjects</h3>
